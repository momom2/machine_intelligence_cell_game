...
| `--text` | Enable the **narrative text layer** (owner, 2026-07-08 — OFF by default): pre-mission briefings (`_pre.brf`), post-battle briefings (`_post.brf`, `L` on the end screen), the in-mission Notes, and the Memory page. Without it all four are hidden. |
