...
impl Faction {
    /// Readable alias for the first AI rival (`Ai(0)`) — single-enemy levels, tests, the headless runner.
    pub const ENEMY: Faction = Faction::Ai(0);
    /// Readable alias for the second AI rival (`Ai(1)`).
    pub const ENEMY2: Faction = Faction::Ai(1);
