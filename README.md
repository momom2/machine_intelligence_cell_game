...
| # | Title | Enemy | (Original lesson — parked) |
|---|---|---|---|
| 1 | First Moves | passive | move ships, capture |
| 2 | Contact | Simple | concentration; layout decides who fights |
| 3 | Two Worlds | Simple | inter-planet fleets, zoom, **automation** |
| 4–6 | Hold the Line / Three Fronts / The Prize | Simple | multi-front play, expansion-vs-defense |
| 7 | The Seam | Simple | (was: exploit the greedy's thin-rear flaw) |
| 8–10 | Overreach / The Turtle / The Hammer | Simple | (was: the attack≻colonize≻defend≻attack RPS edges) |
...
for minutes. The deferred Apprentice/Architect track (`cargo run -p automaton --bin capstone`, etc.)
